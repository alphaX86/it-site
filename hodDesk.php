...
<html lang='en'>
    ...
    <div class='site'>
        <?php include 'header.php'?>
            <div class="flex flex-wrap gap-3 m-2 justify-evenly">
                <div>
                    <a class="flex flex-col md:flex-row md:max-w-3xl md:max-h-full rounded-lg bg-white hover:bg-gray-100 border items-center">
                ...
                <div>
                <a class="grid p-1 bg-white border border-gray-200 rounded-lg max-w-5xl p-10">
